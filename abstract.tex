...
\input abstract.tex
\begin{abstract}
Context: the question of what programming language should be taught first has been fiercely debated since computer science teaching started. Failure to grasp programming readily almost certainly implies failure of the course. 
Inquiry: what first programming languages \emph{are} being taught?
There have been regular surveys in  Australia and New
Zealand, but not in the UK.
Approach: This paper reports the results of the first survey of introductory
programming courses ($\mathrm{N} = 80$) taught at UK universities as
part of their first year computer science (or similar) degree
programmes, conducted in the first half of 2016. 
We report on student numbers, programming paradigm,
...
Python is perceived, by the same respondents, to be both easier to teach as well as to learn.
Grounding: Results of this
...
Zealand. 
Importance: this survey provides a starting point for valuable
